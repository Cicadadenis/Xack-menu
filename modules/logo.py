...
===============================================\033[00m''')
  ...
  def not_ins(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mBednakov-Xack-Live успешно установлен.\033[1;m
\033[1;31m  [ + ]  \033[1;31mЗапустить Bednakov-Xack-Live.\033[1;m
\033[1;31m  [ + ]  \033[1;31mВведите toolx в вашем терминале.\033[1;m''')
    self.tool_footer()
...
\033[1;31m Если вы устанавливаете этот инструмент.
 это означает, что вы согласны со всеми условиями.''')
  ...
  def ins_sc(self):
    self.tool_header()
    print ('''
\033[1;33m    [ + ] \033[1;32mBednakov-Xack-Live  успешно установлен.
\033[1;33m    [ + ] \033[1;32mЗапустить Bednakov-Xack-Live .
\033[1;33m    [ + ] \033[1;32mВведите toolx в вашем терминале.''')
    self.tool_footer()
  ...
  def update(self):
    self.tool_header()
    print ('''
\033[1;33m  [ 1 ] \033[1;32mОбновите ваш Bednakov-Xack-Live
\033[1;33m  [ 0 ] \033[1;32mВернуться.\033[00m''')
  ...
  def updated(self):
    self.tool_header()
    print ('''
\033[1;33m      [ + ] \033[1;32mBednakov-Xack-Live  успешно обновлен.
...
\033[1;31m  [ + ]  \033[1;31mПожалуйста, попробуйте еще раз через некоторое время.\033[00m''')
  ...
  def update_error(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mМы не можем обновить Bednakov-Xack-Live .\033[1;m
\033[1;31m  [ + ]  \033[1;31mПожалуйста, попробуйте еще раз через некоторое время.\033[00m''')
    self.tool_footer()
  ...
  def about(self,total):
    self.tool_header()
    print (f'''
\033[1;33m       [+] Название :- \033[1;32mBednakov-Xack-Live
\033[1;33m       [+] Разроботчик :- \033[1;32mBednakov Denis
\033[1;33m       [+] Обновление :- \033[1;32m04/04/2020.\033[1;m
...
\033[1;33m  [ x ] \033[1;32mВыход.''')
  ...
  def exit(self):
    self.tool_header()
    print ('''
\033[1;33m         [ + ] \033[1;32mСпасибо за использование Bednakov-Xack-Live 
