      ...
      if cmd=="00" or cmd=="back":
        ...
        try:
          if int(cmd)>=1 and int(cmd)<=int(total):
            ...
            print(f"\007\033[01;31mСожалею \033[01;37m: '{cmd}' \033[01;31mНеправильный ввод !!\033[00m")
            sleep(1)
        except ValueError:
          print(f"\007\033[01;31mСожалею \033[01;37m: '{cmd}' \033[01;31mНеправильный ввод !!\033[00m")
          sleep(1)
              ...
              if tcmd=="00" or tcmd=="back":
                ...
                try:
                  ...
                  if int(tcmd) in range(1,int(cat_total)+1):
                    ...
                    print(f"\007\033[01;31mCожалею \033[01;37m: '{tcmd}' \033[01;31mНекорректный ввод !!\033[00m")
                    sleep(1)
                except ValueError:
                  print(f"\007\033[01;31mCожалею \033[01;37m: '{tcmd}' \033[01;31mНекорректный ввод !!\033[00m")
                  sleep(1)
          else:
            print(f"\007\033[01;31mCожалею \033[01;37m: '{cmd}' \033[01;31mНекорректный ввод !!\033[00m")
            sleep(1)
        except ValueError:
          print(f"\007\033[01;31mCожалею \033[01;37m: '{cmd}' \033[01;31mНекорректный ввод !!\033[00m")
          sleep(1)
